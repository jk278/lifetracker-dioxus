...
pub fn create_app_builder() -> tauri::Builder<tauri::Wry> {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            // Timing模块 - 任务管理
            tauri_commands::timing::task::get_tasks,
            tauri_commands::timing::task::create_task,
            tauri_commands::timing::task::update_task,
            tauri_commands::timing::task::delete_task,
            // Timing模块 - 分类管理
            tauri_commands::timing::category::get_categories,
            tauri_commands::timing::category::create_category,
            tauri_commands::timing::category::update_category,
            tauri_commands::timing::category::delete_category,
            // Timing模块 - 计时器
            tauri_commands::timing::timer::get_timer_status,
            tauri_commands::timing::timer::start_timer,
            tauri_commands::timing::timer::pause_timer,
            tauri_commands::timing::timer::resume_timer,
            tauri_commands::timing::timer::stop_timer,
            tauri_commands::timing::timer::get_today_time_entries,
            tauri_commands::timing::timer::get_today_stats,
            // Timing模块 - 时间统计
            tauri_commands::timing::statistics::get_statistics,
            // 财务管理模块
            ...
            // 财务统计
            tauri_commands::accounting::statistics::get_financial_stats,
            tauri_commands::accounting::statistics::get_monthly_trend,
            tauri_commands::accounting::statistics::get_financial_trend,
            // 数据管理
            ...
            tauri_commands::data_io::get_data_statistics,
            // 同步功能
