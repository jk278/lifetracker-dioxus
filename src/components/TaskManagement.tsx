...
const TaskManagement: React.FC<TaskManagementProps> = ({ tasks, onTasksUpdate }) => {
                ...
                {filteredTasks.length === 0 ? (
                    <div className="text-center py-12">
                        ...
                        <p className="text-gray-500 dark:text-gray-400">
                            {searchTerm || selectedCategory ? '没有符合条件的任务' : '创建您的第一个任务开始计时'}
                        </p>
                    </div>
                ) : (
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 p-6">
                        {filteredTasks.map((task) => {
                            ...
                            return (
                                <div key={task.id} className="border border-gray-200 dark:border-gray-600 bg-white dark:bg-gray-700 rounded-lg p-4 hover:shadow-md dark:hover:shadow-gray-700/30 transition-shadow">
                                    ...
                                    <div className="flex items-center justify-between mb-3">
                                        {category ? (
                                            ...
                                            <span className="text-xs text-gray-500 dark:text-gray-400">未分类</span>
                                        )}
