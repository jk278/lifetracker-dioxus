...
const Settings: React.FC<SettingsProps> = () => {
    ...
    const clearData = async () => {
        if (!confirm('这将删除所有数据，包括任务、分类和计时记录。此操作不可恢复，确定要继续吗？')) return;
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                            ...
                            <div className="grid grid-cols-3 gap-3">
                                {[
                                    ...
                                    <button
                                        ...
                                        className={`flex flex-col items-center p-3 rounded-lg border-2 transition-all ${theme === value
                ...
                <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg dark:shadow-gray-700/20 p-6">
                    <div className="flex items-center mb-4">
                        ...
                        <h3 className="text-lg font-semibold text-gray-900 dark:text-white">计时设置</h3>
                    </div>
                    ...
                    <div className="space-y-4">
                        <div>
                            ...
                            <input
                                ...
                                onChange={(e) => setConfig({ ...config, work_session_duration: parseInt(e.target.value) })}
                                className="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-white rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 transition-colors"
                            />
                        </div>
                        ...
                        <div>
                            ...
                            <input
                                ...
                                onChange={(e) => setConfig({ ...config, long_break_duration: parseInt(e.target.value) })}
                                className="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-white rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 transition-colors"
                            />
                        </div>
                    </div>
